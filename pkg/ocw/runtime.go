...
type Runtime interface {
	Run(ctx context.Context, step *schema.RunStep, prefix string, bus *EventBus) (map[string]string, error)
	Build(ctx context.Context, step *schema.BuildStep, prefix string, bus *EventBus) (map[string]string, error)
	...
	StartService(ctx context.Context, step *schema.RunStep, prefix string, bus *EventBus) (map[string]string, error)
